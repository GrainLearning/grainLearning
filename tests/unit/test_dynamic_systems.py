...
class TestIODynamicSystem:
    ...
    def test_run(self):
        ...
        assert system_cls.param_data_file == GL_PATH + '/tests/unit/sim_data/iter0/test_Iter0_Samples.txt'
        ...
        for i, f in enumerate(system_cls.sim_data_files):
            ...
            assert f == GL_PATH + f'/tests/unit/sim_data/iter0/test_{description}_sim.txt'
