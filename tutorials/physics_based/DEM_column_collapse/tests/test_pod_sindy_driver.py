import os
import numpy as np
from rom_pipeline import PodSindyROM
...
def main():
    ...
    # Fit and evaluate reconstruction on full data
    rom = PodSindyROM(normalization=True, energy=0.99, num_modes=3, poly_degree=2, thresh=0.1, diff="smoothed", tag="POD-SINDY")
